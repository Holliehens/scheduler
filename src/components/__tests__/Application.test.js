...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for the first day by 1", async () => {
    ...
    expect(
      getByText(appointment, "Saving", { exact: false })
    ).toBeInTheDocument();
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    expect(
      getByText(appointment, "Deleting", { exact: false })
    ).toBeInTheDocument();
  ...
  it.only("shows the delete error when failing to delete an existing appointment", async () => {
    axios.delete.mockRejectedValueOnce("Error Deleting Appointment");
    ...
    //4. Check that the confirmation message is showing
    expect(
    ...
    //6. Wait for "Deleting..." mode to show
    ...
    // 7. Check that message "Error Deleting Appointment" is showing
